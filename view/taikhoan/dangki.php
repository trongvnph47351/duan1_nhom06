...
.axil-signin-banner {
    ...
    text-align: center;
    margin-bottom: 20px;
    /* Adds space between the banner and the image */
    border-radius: 8px;
    /* Optional: Rounds the corners of the banner */
...
.col-xl-4 img {
    ...
    display: block;
    /* Removes any inline characteristics */
    margin-top: 20px;
    /* Adds space above the image */
    border-radius: 8px;
    /* Rounds the corners of the image */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
    /* Adds a subtle shadow to lift the image off the page */
    height: 700px;
}
...
<body>
    ...
    <div class="signin-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <a href="index.php" class="site-logo"><img src="img/logo/logo5.png" alt="logo"></a>
            </div>
            <div class="col-md-6">
        ...
        <div class="col-lg-6 offset-xl-2">
            <div class="axil-signin-form-wrap">
                <div class="axil-signin-form">
                    ...
                    <p class="b2 mb--55">Nhập thông tin tài khoản bạn muốn</p>
                    <form class="singin-form" action="index.php?act=dangky" method="POST">
                        ...
                        <div class="form-group">
                            <input type="submit" class="axil-btn btn-bg-primary submit-btn" name="submit"
